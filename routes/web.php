...
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(static function () {
    Route::prefix('admin')->namespace('App\Http\Controllers\Admin')->name('admin/')->group(static function() {
        Route::prefix('games')->name('games/')->group(static function() {
            ...
            Route::post('/bulk-destroy',                                'GamesController@bulkDestroy')->name('bulk-destroy');
            Route::post('/{game}',                                      'GamesController@update')->name('update');
            Route::delete('/{game}',                                    'GamesController@destroy')->name('destroy');
        });
    });
});
...
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(static function () {
    Route::prefix('admin')->namespace('App\Http\Controllers\Admin')->name('admin/')->group(static function() {
        Route::prefix('gamers')->name('gamers/')->group(static function() {
            Route::get('/',                                             'GamersController@index')->name('index');
            Route::get('/create',                                       'GamersController@create')->name('create');
            Route::post('/',                                            'GamersController@store')->name('store');
            Route::get('/{gamer}/edit',                                 'GamersController@edit')->name('edit');
            Route::post('/bulk-destroy',                                'GamersController@bulkDestroy')->name('bulk-destroy');
            Route::post('/{gamer}',                                     'GamersController@update')->name('update');
            Route::delete('/{gamer}',                                   'GamersController@destroy')->name('destroy');
        });
    });
});
...
Route::middleware(['auth:' . config('admin-auth.defaults.guard'), 'admin'])->group(static function () {
    Route::prefix('admin')->namespace('App\Http\Controllers\Admin')->name('admin/')->group(static function() {
        Route::prefix('items')->name('items/')->group(static function() {
            ...
            Route::post('/bulk-destroy',                                'ItemController@bulkDestroy')->name('bulk-destroy');
